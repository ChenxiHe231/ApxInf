...
Set ``APXINF_QWEN3VL_MODEL_DIR`` to the local Qwen3-VL model directory before
running this script.
"""
import os
...
MODEL = os.environ.get("APXINF_QWEN3VL_MODEL_DIR")
if not MODEL:
    raise RuntimeError(
        "APXINF_QWEN3VL_MODEL_DIR is required; set it to the local "
        "Qwen3-VL model directory"
    )
