#!/usr/bin/env python3
"""Regenerate the checked-in GEMM oracle with PyTorch.
...
def main() -> None:
    ...
    destination = Path(__file__).parents[1] / "src" / "ops" / "torch_l3_fixtures.rs"
    destination.write_text(
        "// @generated by tests/generate_torch_l3_fixtures.py\n"
