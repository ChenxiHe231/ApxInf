...
pub(crate) struct TuningBindings {
    ...
    /// Optional test-only output generated by the independent Torch oracle.
    pub expected_output: *const f32,
    pub expected_output_len: u64,
    /// 0 reconstructs typed inputs; 1 uses `expected_output` directly.
