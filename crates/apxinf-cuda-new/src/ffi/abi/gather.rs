...
unsafe extern "C" {
    pub(crate) fn apxinf_gather_prepare(
        runtime: Runtime,
        spec: *const Spec,
        policy: *const Policy,
    ...
    pub(crate) fn apxinf_gather_enqueue(execution: Execution) -> i32;
    pub(crate) fn apxinf_gather_destroy(execution: Execution);
    #[cfg(test)]
    pub(crate) fn apxinf_gather_summary(execution: Execution) -> *const c_char;
}
