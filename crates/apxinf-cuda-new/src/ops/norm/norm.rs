...
impl<'a> RmsNormArgs<'a> {
    pub fn new(input: &'a Tensor, weight: &'a Tensor, normalized: &'a mut Tensor, eps: f32) -> Self {
        Self { input, weight, normalized, eps }
    }
}
...
impl<'a> LayerNormArgs<'a> {
    pub fn new(input: &'a Tensor, weight: &'a Tensor, bias: &'a Tensor, normalized: &'a mut Tensor, eps: f32) -> Self {
        Self { input, weight, bias, normalized, eps }
    }
}
...
impl<'a> AdaptiveRmsNormArgs<'a> {
    pub fn new(input: &'a Tensor, norm_style: &'a Tensor, normalized: &'a mut Tensor, eps: f32) -> Self {
        Self { input, norm_style, normalized, eps }
    }
}
...
impl<'a> BiasResidualRmsNormArgs<'a> {
    ...
    pub fn new(input: &'a Tensor, bias: Option<&'a Tensor>, residual: &'a Tensor, weight: &'a Tensor, hidden: &'a mut Tensor, normalized: &'a mut Tensor, eps: f32) -> Self {
        Self { input, bias, residual, weight, hidden, normalized, eps }
    }
}
...
impl<'a> BiasResidualLayerNormArgs<'a> {
    ...
    pub fn new(input: &'a Tensor, bias: Option<&'a Tensor>, residual: &'a Tensor, weight: &'a Tensor, norm_bias: &'a Tensor, hidden: &'a mut Tensor, normalized: &'a mut Tensor, eps: f32) -> Self {
        Self { input, bias, residual, weight, norm_bias, hidden, normalized, eps }
    }
}
...
impl<'a> AdaGateResidualRmsNormArgs<'a> {
    ...
    pub fn new(input: &'a Tensor, residual: &'a Tensor, norm_style: &'a Tensor, gate_style: &'a Tensor, hidden: &'a mut Tensor, normalized: &'a mut Tensor, eps: f32) -> Self {
        Self { input, residual, norm_style, gate_style, hidden, normalized, eps }
    }
}
...
pub fn rms_norm(ctx: &CudaContext, args: RmsNormArgs<'_>) -> Result<()> {
    execute(ctx, RawArgs { semantic: Semantic::Rms, input: args.input, bias: None, residual: None, weight: Some(args.weight), norm_bias: None, norm_style: None, gate_style: None, hidden: None, normalized: Some(args.normalized), eps: args.eps })
}

pub fn layer_norm(ctx: &CudaContext, args: LayerNormArgs<'_>) -> Result<()> {
    execute(ctx, RawArgs { semantic: Semantic::Layer, input: args.input, bias: None, residual: None, weight: Some(args.weight), norm_bias: Some(args.bias), norm_style: None, gate_style: None, hidden: None, normalized: Some(args.normalized), eps: args.eps })
}

pub fn adaptive_rms_norm(ctx: &CudaContext, args: AdaptiveRmsNormArgs<'_>) -> Result<()> {
    execute(ctx, RawArgs { semantic: Semantic::AdaptiveRms, input: args.input, bias: None, residual: None, weight: None, norm_bias: None, norm_style: Some(args.norm_style), gate_style: None, hidden: None, normalized: Some(args.normalized), eps: args.eps })
}

pub fn bias_residual(ctx: &CudaContext, args: BiasResidualArgs<'_>) -> Result<()> {
    execute(ctx, RawArgs { semantic: Semantic::BiasResidual, input: args.input, bias: args.bias, residual: Some(args.residual), weight: None, norm_bias: None, norm_style: None, gate_style: None, hidden: Some(args.hidden), normalized: None, eps: 1e-6 })
}

pub fn bias_residual_rms_norm(ctx: &CudaContext, args: BiasResidualRmsNormArgs<'_>) -> Result<()> {
    execute(ctx, RawArgs { semantic: Semantic::BiasResidualRms, input: args.input, bias: args.bias, residual: Some(args.residual), weight: Some(args.weight), norm_bias: None, norm_style: None, gate_style: None, hidden: Some(args.hidden), normalized: Some(args.normalized), eps: args.eps })
}

pub fn bias_residual_layer_norm(ctx: &CudaContext, args: BiasResidualLayerNormArgs<'_>) -> Result<()> {
    execute(ctx, RawArgs { semantic: Semantic::BiasResidualLayer, input: args.input, bias: args.bias, residual: Some(args.residual), weight: Some(args.weight), norm_bias: Some(args.norm_bias), norm_style: None, gate_style: None, hidden: Some(args.hidden), normalized: Some(args.normalized), eps: args.eps })
}

pub fn ada_gate_residual(ctx: &CudaContext, args: AdaGateResidualArgs<'_>) -> Result<()> {
    execute(ctx, RawArgs { semantic: Semantic::AdaGateResidual, input: args.input, bias: None, residual: Some(args.residual), weight: None, norm_bias: None, norm_style: None, gate_style: Some(args.gate_style), hidden: Some(args.hidden), normalized: None, eps: 1e-6 })
}

pub fn ada_gate_residual_rms_norm(ctx: &CudaContext, args: AdaGateResidualRmsNormArgs<'_>) -> Result<()> {
    execute(ctx, RawArgs { semantic: Semantic::AdaGateResidualRms, input: args.input, bias: None, residual: Some(args.residual), weight: None, norm_bias: None, norm_style: Some(args.norm_style), gate_style: Some(args.gate_style), hidden: Some(args.hidden), normalized: Some(args.normalized), eps: args.eps })
}

pub fn bias_then_residual(ctx: &CudaContext, args: BiasThenResidualArgs<'_>) -> Result<()> {
    execute(ctx, RawArgs { semantic: Semantic::BiasThenResidual, input: args.input, bias: args.bias, residual: Some(args.residual), weight: None, norm_bias: None, norm_style: None, gate_style: None, hidden: Some(args.hidden), normalized: None, eps: 1e-6 })
}
